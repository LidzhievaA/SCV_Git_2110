...
## 13. Запрос изменений Pull request.
Для того, чтобы предложить изменения в чужой репозиторий необходимо выполнить следующие пункты:

1. Зайти на страницу проекта, создать собственную его копию с помощью кнопки **Fork** . Теперь файлы отобразятся на вашей странице, то есть появится возможность вносить изменения.

2. Скопировать файлы на свой локальный репозиторий.

3. Создать новую ветку и все изменения внести только в ней. 

4. Зафиксировать изменения.

5. Отправить свою версию в свой GitHub .

6. Перейти в свой репозиторий на GitHub, нажать кнопку **Compare & pull request**.

7. При необходимости внести комментарии или описание изменений, после нажать кнопку **Create pull request**.

Таким образом, владелец проекта получит уведомление о предложенных изменениях и сможет просмотреть предложенные изменения, принять, отклонить или прокомментировать их.